...
class TestBossThread(sopTester.SopThreadTester,unittest.TestCase):
    ...
    def _single_hartmann(self,nCall,nInfo,nWarn,nErr, expTime, mask, finish=False,didFail=False):
    ...
    def _hartmann(self, nCall,nInfo,nWarn,nErr, args='', didFail=False):
        ...
        self._check_cmd(nCall, nInfo, nWarn, nErr, False, didFail, reply=['boss',sopActor.Msg.EXPOSURE_FINISHED])
